...
abstract class AbstractDockerService
{
    ...
    /**
     * Retrieves a collection of all the currently running Docker containers.
     *
     * @return \Illuminate\Support\Collection A collection of the names of the running containers.
     */
    public function getAllRunningContainers(): Collection
    {
        ...
        return collect(array_filter(explode(PHP_EOL, $this->cli->runAsUser($command, [$this, 'handleDockerError']))));
    }
    ...
    /**
     * Handles an error that occurs during a Docker operation.
     *
     * @param int $exitCode The exit code of the Docker operation.
     * @param string $errorOutput The error output generated by the Docker operation.
     *
     * @throws DomainException If Docker was unable to check which containers are running.
     */
    protected function handleDockerError($exitCode, $errorOutput)
    {
        output($errorOutput);
